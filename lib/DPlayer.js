...
function _libdriveDplayer() {
  var data = _interopRequireDefault(require("libdrive-dplayer"));

  _libdriveDplayer = function _libdriveDplayer() {
    return data;
  };
...
var DPlayerComponent = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(DPlayerComponent, [{
    ...
    value: function componentDidMount() {
      ...
      var player = this.dp = new (_libdriveDplayer().default)(_objectSpread(_objectSpread({}, Object.assign({}, {
        lang: 'en',
        contextmenu: [{
          text: "GitHub",
